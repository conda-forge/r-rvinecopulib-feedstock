About r-rvinecopulib-feedstock
==============================
...
<table><tr>
    ...
    <td>
      <a href="https://github.com/conda-forge/r-rvinecopulib-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/r-rvinecopulib-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
      ...
      <details>
        ...
        <table>
          ...
          <tbody><tr>
              ...
              <td>
                <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=16144&branchName=main">
                  <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/r-rvinecopulib-feedstock?branchName=main&jobName=osx&configuration=osx%20osx_64_r_base4.5" alt="variant">
                </a>
              </td>
            </tr>
          </tbody>
...
pixi add r-rvinecopulib
# for installing globally
pixi global install r-rvinecopulib
```
...
It is possible to list all of the versions of `r-rvinecopulib` available on your platform:
...
```
pixi search r-rvinecopulib --channel conda-forge
```
